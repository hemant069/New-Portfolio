              ...
              <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
                <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Link
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="p-1.5 sm:p-2 rounded-md hover:bg-gray-800/50 transition-colors"
                    aria-label="Visit live site"
                  >
                    <Globe className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 hover:text-white transition-colors" />
                  </Link>
                </motion.div>
                ...
                {data.video && (
                  <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                    <Dialog>
                      ...
                      >
                        <Play className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400 hover:text-white transition-colors fill-gray-400" />
                      </DialogTrigger>
                      <VideoComponent isVideo={isVideo} video={data.video} />
                    </Dialog>
                  </motion.div>
